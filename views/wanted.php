	...
	<div class="content-panel">
		<table class="table table-striped table-advance table-hover">
			...
			if (!$db_connection->connect_errno) {
				...
				echo "<center><a class='btn btn-primary' href='wanted.php?page=1'>".$lang['first']."</a> ";?>
				<div class="btn-group">
				...
				<?php
				echo "<a class='btn btn-primary' href='wanted.php?page=$total_pages'>".$lang['last']."</a></center>";
