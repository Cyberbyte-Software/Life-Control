                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            <?php echo $lang['vehicles'];?><small><?php echo " ". $lang['overview'];?></small>
                        </h1>
						<div class="col-lg-4" style="top:3px;float:right;">
							<form style="float:right;" method='post' action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" name='searchPlayer'>
								...
								<input class='btn btn-sm btn-primary'  type='submit'  name='class' value='<?php echo $lang['search']." ".$lang['class'];?>'>
							</form>
						</div>
                        <ol class="breadcrumb">
                            <li class="active">
