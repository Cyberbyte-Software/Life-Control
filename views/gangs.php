	...
	<div class="content-panel">
		<table class="table table-striped table-advance table-hover">
			...
			if (!$db_connection->connect_errno) {
				...
				echo "<center><a class='btn btn-primary' href='gangs.php?page=1'>".'First Page'."</a> ";

				for ($i=1; $i<=$total_pages; $i++) {
					echo "<a class='btn btn-primary' href='gangs.php?page=".$i."'>".$i."</a> ";
				};

				echo "<a class='btn btn-primary' href='gangs.php?page=$total_pages'>".'Last Page'."</a></center>";
			} else {
