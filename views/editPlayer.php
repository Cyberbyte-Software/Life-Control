...
if (isset($_GET["ID"])) {
                ...
                <div class="tab-pane fade" id="house">
                    <div class="table-responsive">
                        ...
                        if ($result_of_query->num_rows > 0) {
                            ...
                            <?php echo '<a class="fa fa-caret-right fa-2x" style="float: right; padding-right:15px;" href="houses.php?ID=' . $pID . '"> More</a>';
    ...
    <div class="modal fade" id="edit_med_licenses" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
         aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
